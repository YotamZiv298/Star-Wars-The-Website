<%@ Page Title="הרשמה לאתר" Language="C#" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function CheckForm() {
            ...
            CheckSelect(Day, 'יום') &&
            CheckSelect(Month, 'חודש') &&
            CheckSelect(Year, 'שנה') &&
            CheckRadio("Gender", 'מין') &&
            CheckSelect(Kidomet, 'קידומת') &&
            CheckPhone(Phone, 'טלפון') &&
            CheckEmail(Email) &&
            CheckUser(Nickname, 'שם משתמש', 6, 16) &&
        ...
        function CheckSelect(Value, Text) {
        ...
        function CheckUser(User, Text, Min, Max) {
            var str = User.value;
            var letter;
            ...
            for (i = 0; i < str.length; i++) {
                ...
                if (!(((letter >= 'A') && (letter <= 'Z')) || ((letter >= 'a') && (letter <= 'z')) || ((letter >= '0') && (letter <= '9')))) {
                    alert("הכנס " + Text + " עם אותיות באנגלית ו/או מספרים");
                    User.select();
                    return false;
                }
            }
        ...
        function CheckBox() {
            if (!(Pratim.Tnaim.checked)) {
                alert("בכדי להירשם עליך להסכים לתנאים של האתר");
                return false;
            }
            return true;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center>
        <table bgcolor="white" width="77%" border="0" dir="rtl">
            <tr>
                <td>
                    <form name="Pratim" method="post" onsubmit="return CheckForm()"
                    action="AddUser.aspx" style="font-family: Arial;">
                    <br />
                    <center>
                        ...
                        <table cellpadding="5">
                            <tr>
                                ...
                                <td>
                                    <input id="FirstName" type="text" name="FirstName" maxlength="10" size="7" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input id="LastName" type="text" name="LastName" maxlength="10" size="7" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="Male" type="radio" name="Gender" value="male" />זכר
                                    <input id="Female" type="radio" name="Gender" value="female" />נקבה
                                </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <table cellpadding="5">
                            <tr>
                                ...
                                <td>
                                    <input id="Phone" type="text" name="Phone" maxlength="7" size="6" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="Email" type="text" name="Email" maxlength="30" size="29" />
                                </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <table cellpadding="5">
                            <tr>
                                ...
                                <td>
                                    <input id="Nickname" type="text" name="Nickname" maxlength="16" size="14" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input id="Pass" type="password" name="Pass" maxlength="16" size="7" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input id="Verify" type="password" name="Verify" maxlength="16" size="7" />
                                </td>
                            </tr>
                        </table>
                        <br />
                        <table cellpadding="5">
                            <tr>
                                <td>
                                    <input id="Tnaim" type="checkbox" name="Tnaim" />
                                </td>
                                <td>
                                    מסכים לתנאי האתר
                                </td>
                        ...
                        <table cellpadding="5">
                            <tr>
                                <td align="center">
                                    <input type="submit" value="שלח" style="width: 71px" />
                                </td>
                                <td align="center">
                                    <input type="reset" value="אפס" style="width: 71px" />
                                </td>
                            </tr>
                        </table>
                    </center>
